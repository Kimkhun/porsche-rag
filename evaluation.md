...
| 3 | How do Porsche engines differ from other sports car engines? | Technical | Porsche 911 GT2, Porsche V10 Engine, Porsche 911 (997), Porsche 911 (Classic), Porsche Panamera | ⚠️ Corpus limitation — V10 Engine found (#4), V8 Engines at #10 (needs higher top_k). Flat-six article doesn't exist on Wikipedia | Decent on specific examples but lacked a comprehensive comparison. Not fixable without adding more sources |
